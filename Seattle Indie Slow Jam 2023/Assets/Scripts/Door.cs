...
public class Door : MonoBehaviour, IAttackable
{
    ...
    private void DestroyMesh()
    {
        ...
        Rigidbody[] rigidbodies = new Rigidbody[1000000];
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(Door original)
        {
            ...
            var debrisFade = GameObject.AddComponent<DebrisFade>();
